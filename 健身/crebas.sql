...
(
   area_id              int not null comment '主键',
...
(
   consume_record_id    bigint not null comment '主键',
   openid               varchar(255) comment '微信用户',
...
(
   gymnasium_id         int not null comment '主键',
...
(
   gymnasium_type_id    int not null comment '主键',
   name                 varchar(255) comment '名称',
   create_date          varchar(255) comment '创建时间',
   create_user          varchar(255) comment '创建人',
   update_date          varchar(255) comment '修改时间',
...
(
   lock_id              int not null comment '主键',
...
(
   option_id            int not null comment '主键',
